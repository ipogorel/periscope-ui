...
System.register(['aurelia-framework', 'jquery', 'periscope-framework'], function (_export, _context) {
  var Container, Decorators, bindable, $, StringHelper, DslExpressionManagerFactory, SearchBox, _createClass, DefaultSearchBox;
  ...
  return {
    setters: [function (_aureliaFramework) {
      ...
      StringHelper = _periscopeFramework.StringHelper;
      DslExpressionManagerFactory = _periscopeFramework.DslExpressionManagerFactory;
    ...
    execute: function () {
      ...
      _export('DefaultSearchBox', DefaultSearchBox = function (_SearchBox) {
      ...
      _export('DefaultSearchBox', DefaultSearchBox);
    }
  };
});